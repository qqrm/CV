...
## Tooling reference
Use locally available Rust and Typst toolchains for development. Document any extra CLI dependencies next to the workflows or scripts that need them instead of maintaining a separate environment manifest.
...
- Generate the canonical Typst PDFs and copy them into the Pages artifact root alongside the WebAssembly bundle.
