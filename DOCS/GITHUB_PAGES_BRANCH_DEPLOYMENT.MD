...
This guide explains how to publish the static bundle (including the `new/` WebAssembly site served at `/CV/`) from a branch that is different from the default branch.
